export const ro: Record<string, string> = {
  ...
  "project.share.dialogDescription": "Oricine are acest link poate vedea proiectul. Pentru vot sau comentariu trebuie să se autentifice.",
  "project.share.noLinkYet": "Niciun link public încă. Generează unul pentru a distribui proiectul.",
  "project.share.generate": "Generează link",
  "project.share.generated": "Link de share generat",
  "project.share.copy": "Copiază",
  "project.share.copied": "Link copiat în clipboard",
  "project.share.linkLabel": "Link public de share",
  "project.share.hint": "Oricine are acest link poate vedea proiectul, dar trebuie să se autentifice pentru vot sau comentariu.",
  "project.share.revoke": "Revocă",
  "project.share.revoked": "Link de share revocat",
  "project.share.rotate": "Rotește",
  "project.share.confirmRevoke": "Oricine are linkul actual va pierde accesul. Continui?",
  "project.share.guestBannerPrompt": "Autentifică-te pentru a vota și participa la discuții",
  "project.share.guestVotePrompt": "Autentifică-te pentru a vota",
  "project.share.guestCommentPrompt": "Autentifică-te pentru a adăuga un comentariu",
  "project.share.signIn": "Autentifică-te",
  "project.share.signInToComment": "Autentifică-te pentru a comenta",
  "error.shareDraft": "Proiectele în stadiu de draft nu pot fi distribuite. Publică proiectul mai întâi.",
  ...
  "admin.searchAnalytics": "Analitică Căutare",
  "admin.totalSearches": "Total Căutări",
  "admin.uniqueQueries": "Interogări Unice",
  "admin.clickThroughRate": "Rata Click",
  "admin.zeroResultRate": "Rata Fără Rezultate",
  "admin.avgResponseTime": "Timp Mediu Răspuns",
  "admin.searchesByMode": "Căutări pe Mod",
  "admin.popularSearches": "Căutări Populare",
  ...
  "admin.exportSuccess": "Export descărcat cu succes",
  "admin.embeddingQuality": "Calitate Embedding",
  "admin.embeddingQualityDesc": "Măsoară acuratețea similarității embedding-urilor și urmărește calitatea în timp",
  "admin.qualityScore": "Scor Calitate",
  "admin.avgSimilarity": "Similaritate Medie",
  "admin.sampleSize": "Dimensiune Eșantion",
  "admin.qualityTrend": "Tendință Calitate",
  "admin.qualityGood": "Bun",
  "admin.qualityFair": "Acceptabil",
  "admin.qualityPoor": "Slab",
  "admin.selfSimilarity": "Auto-Similaritate",
  "admin.crossSimilarity": "Similaritate Inter-Tip",
  "admin.ciBuildComparison": "Comparare Build-uri",
  "admin.ciBuildComparisonDesc": "Comparație laterală a build-urilor CI între ramuri",
  "admin.compareBranches": "Compară Ramuri",
  "admin.branchA": "Ramura A",
  "admin.branchB": "Ramura B",
  "admin.buildDuration": "Durată",
  "admin.buildSize": "Dimensiune",
  "admin.buildStatus": "Status",
  "admin.noBranchBuilds": "Niciun build găsit pentru această ramură",
  "admin.durationDiff": "Diferența de Durată",
  "admin.sizeDiff": "Diferența de Dimensiune",
  "admin.notificationPrefs": "Preferințe Notificări",
  "admin.notificationPrefsDesc": "Configurează ce alerte primești pentru CI, calitatea căutării și evenimente de sistem",
  "admin.notifCategoryCi": "Alerte Build CI",
  "admin.notifCategorySearch": "Alerte Calitate Căutare",
  "admin.notifCategoryEmbedding": "Alerte Embedding",
  "admin.notifCategorySystem": "Evenimente Sistem",
  "admin.notifChannelInApp": "În Aplicație",
  "admin.notifChannelEmail": "Email",
  "admin.notifEnabled": "Activat",
  "admin.notifDisabled": "Dezactivat",
  "admin.notifSaved": "Preferințele de notificare au fost salvate",
  "admin.notifSaveError": "Nu s-au putut salva preferințele de notificare",
  ...
  "search.dateFrom": "De la data",
  "search.dateTo": "Până la data",
  "search.filterByAuthor": "Filtrare după autor",
  "search.filterByTag": "Filtrare după etichetă",
  "search.minVotes": "Min. voturi",
  "search.projectScope": "În cadrul proiectului",
  "search.clearFilters": "Șterge filtrele",
  "search.showFilters": "Arată filtrele",
  "search.hideFilters": "Ascunde filtrele",
  "search.savedSearches": "Căutări Salvate",
  "search.saveSearch": "Salvează căutarea",
  "search.saveName": "Numele căutării",
  "search.exportResults": "Exportă rezultatele",
  "search.didYouMean": "Ați vrut să spuneți",
  "search.suggestions": "Sugestii",
  "search.filterByType": "Filtrare după tip",
  ...
  "permissions.description": "Gestionează reguli bazate pe timp, permisiuni dinamice și ACL-uri de resurse",
  "permissions.testTool": "Testare și simulare",
  "permissions.totalRules": "Total reguli",
  "permissions.activeRules": "Reguli active",
  "permissions.totalAcls": "ACL-uri resurse",
  "permissions.denyRules": "Reguli de refuzare",
  "permissions.rules": "Reguli de permisiune",
  "permissions.rulesDesc": "Reguli de permisiune bazate pe timp, programare, termen limită și condiții",
  "permissions.acls": "ACL-uri resurse",
  "permissions.aclsDesc": "Intrări de control al accesului la nivel de resursă",
  "permissions.createRule": "Creează regulă",
  "permissions.createAcl": "Creează ACL",
  "permissions.ruleName": "Nume regulă",
  "permissions.ruleNamePlaceholder": "ex. Editare doar în orele de lucru",
  "permissions.ruleType": "Tip regulă",
  "permissions.ruleType_time_expiry": "Expirare temporală",
  "permissions.ruleType_schedule": "Programare",
  "permissions.ruleType_deadline": "Termen limită",
  "permissions.ruleType_condition": "Condiție",
  "permissions.targetType": "Tip țintă",
  "permissions.targetType_user": "Utilizator specific",
  "permissions.targetType_role": "Rol",
  "permissions.targetType_all": "Toți utilizatorii",
  "permissions.targetUser": "Utilizator",
  "permissions.targetRole": "Rol",
  "permissions.selectUser": "Selectează un utilizator...",
  "permissions.selectRole": "Selectează un rol...",
  "permissions.permission": "Permisiune",
  "permissions.effect": "Efect",
  "permissions.effect_grant": "Acordare",
  "permissions.effect_deny": "Refuzare",
  "permissions.expiresAt": "Expiră la",
  "permissions.schedule": "Programare (JSON)",
  "permissions.condition": "Condiție (JSON)",
  "permissions.target": "Țintă",
  "permissions.inactive": "Inactiv",
  "permissions.expired": "Expirat",
  "permissions.disable": "Dezactivează",
  "permissions.enable": "Activează",
  "permissions.noRules": "Nicio regulă de permisiune configurată",
  "permissions.noAcls": "Niciun ACL de resursă configurat",
  "permissions.entityType": "Tip entitate",
  "permissions.entityId": "ID entitate",
  "permissions.entityIdPlaceholder": "Introduceți UUID-ul entității",
  "permissions.entityProject": "Proiect",
  "permissions.entityProposal": "Propunere",
  "permissions.granteeType": "Tip beneficiar",
  "permissions.granteeUser": "Utilizator",
  "permissions.granteeRole": "Rol",
  "permissions.granteeId": "Beneficiar",
  "permissions.reason": "Motiv",
  "permissions.reasonPlaceholder": "Motivul pentru această intrare ACL",
  "permissions.optional": "opțional",
  "permissions.none": "Niciunul",
  "permissions.testTitle": "Simulator permisiuni",
  "permissions.testDesc": "Testați evaluarea permisiunilor pentru orice combinație de utilizator, rol și resursă",
  "permissions.simulateTitle": "Simulare verificare permisiuni",
  "permissions.simulateRole": "Simulează ca rol",
  "permissions.runSimulation": "Rulează simularea",
  "permissions.allowed": "Permis",
  "permissions.denied": "Refuzat",
  "permissions.finalVerdict": "Verdictul final",
  "permissions.ruleId": "ID regulă",
  "permissions.staticRbac": "Rezultat RBAC static",
  "permissions.matchingRules": "Reguli potrivite",
  ...
  "collaboration.reviewing": "recenzie",
  "collaboration.typing": "tastează",
  "collaboration.idle": "inactiv",
  ...
  "perfDashboard.title": "Panou performanță",
  "perfDashboard.subtitle": "Metrici de performanță unificate, statistici cache și alerte",
  "perfDashboard.avgResponse": "Răspuns mediu",
  "perfDashboard.cacheHitRate": "Rată cache",
  "perfDashboard.memoryUsage": "Utilizare memorie",
  "perfDashboard.activeAlerts": "Alerte active",
  "perfDashboard.dbPool": "Pool baze de date",
  "perfDashboard.maxConn": "Conexiuni maxime",
  "perfDashboard.activeConn": "Active",
  "perfDashboard.idleConn": "Inactive",
  "perfDashboard.peakActive": "Vârf activ",
  "perfDashboard.totalAcquired": "Total achiziții",
  "perfDashboard.stmtsCached": "Cache declarații",
  "perfDashboard.cacheDetails": "Detalii cache",
  "perfDashboard.memEntries": "Intrări memorie",
  "perfDashboard.redisEnabled": "Redis activ",
  "perfDashboard.redisHits": "Accesări Redis",
  "perfDashboard.trackedTags": "Etichete urmărite",
  "perfDashboard.taggedKeys": "Chei etichetate",
  ...
  "integrations.loadFailed": "Nu s-au putut încărca datele de integrare",
  "integrations.platformTitle": "Integrări platforme",
  "integrations.namePlaceholder": "Nume integrare",
  "integrations.webhookUrlPlaceholder": "https://hooks.slack.com/services/...",
  "integrations.addIntegration": "Adaugă integrare",
  "integrations.noIntegrations": "Nicio integrare de platformă configurată",
  "integrations.created": "Integrare creată",
  "integrations.createFailed": "Nu s-a putut crea integrarea",
  "integrations.deleted": "Integrare ștearsă",
  "integrations.deleteFailed": "Nu s-a putut șterge integrarea",
  "integrations.updateFailed": "Nu s-a putut actualiza integrarea",
  "integrations.test": "Testează integrarea",
  "integrations.testSuccess": "Mesajul de test a fost trimis cu succes",
  "integrations.testFailed": "Mesajul de test a eșuat",
  "integrations.deliveriesTotal": "Total livrări",
  "integrations.deliveriesSuccess": "Reușite",
  "integrations.deliveriesFailed": "Eșuate",
  "integrations.activeKeys": "Chei API active",
  "integrations.apiKeysTitle": "Chei API",
  "integrations.keyNamePlaceholder": "Nume cheie (ex: Pipeline CI/CD)",
  "integrations.createKey": "Creează cheie",
  "integrations.keyCreated": "Cheie API creată",
  "integrations.keyCreateFailed": "Nu s-a putut crea cheia API",
  "integrations.keyRevealMessage": "Salvează această cheie — nu va mai fi afișată:",
  "integrations.dismissKey": "Închide",
  "integrations.noKeys": "Nicio cheie API creată",
  "integrations.requests": "cereri",
  "integrations.perHour": "oră",
  "integrations.lastUsed": "Ultima utilizare",
