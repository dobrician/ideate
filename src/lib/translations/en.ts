export const en: Record<string, string> = {
  ...
  "digest.projectsCreated": "{count} new project(s) created",
  "digest.proposalsSubmitted": "{count} new proposal(s) submitted",
  "digest.votesCast": "{count} vote(s) cast",
  "digest.commentsPosted": "{count} comment(s) posted",
