export const en: Record<string, string> = {
  ...
  // Project share
  "project.share.button": "Share",
  "project.share.dialogTitle": "Share this project",
  "project.share.dialogDescription": "Anyone with this link can view the project. They'll need to sign in to vote or comment.",
  "project.share.noLinkYet": "No public link yet. Generate one to share this project.",
  "project.share.generate": "Generate link",
  "project.share.generated": "Share link generated",
  "project.share.copy": "Copy",
  "project.share.copied": "Link copied to clipboard",
  "project.share.linkLabel": "Public share link",
  "project.share.hint": "Anyone with this link can view the project but must sign in to vote or comment.",
  "project.share.revoke": "Revoke",
  "project.share.revoked": "Share link revoked",
  "project.share.rotate": "Rotate",
  "project.share.confirmRevoke": "Anyone with the current link will lose access. Continue?",
  "project.share.guestBannerPrompt": "Sign in to vote and join the discussion",
  "project.share.guestVotePrompt": "Sign in to vote",
  "project.share.guestCommentPrompt": "Sign in to add a comment",
  "project.share.signIn": "Sign in",
  "project.share.signInToComment": "Sign in to comment",
  "error.shareDraft": "Draft projects cannot be shared. Publish the project first.",
  ...
  "admin.uniqueQueries": "Unique Queries",
  "admin.clickThroughRate": "Click-Through Rate",
  "admin.zeroResultRate": "Zero-Result Rate",
  "admin.avgResponseTime": "Avg Response Time",
  "admin.searchesByMode": "Searches by Mode",
  ...
  "admin.exportSuccess": "Export downloaded successfully",
  "admin.embeddingQuality": "Embedding Quality",
  "admin.embeddingQualityDesc": "Measure embedding similarity accuracy and track quality over time",
  "admin.qualityScore": "Quality Score",
  "admin.avgSimilarity": "Avg Similarity",
  "admin.sampleSize": "Sample Size",
  "admin.qualityTrend": "Quality Trend",
  "admin.qualityGood": "Good",
  "admin.qualityFair": "Fair",
  "admin.qualityPoor": "Poor",
  "admin.selfSimilarity": "Self-Similarity",
  "admin.crossSimilarity": "Cross-Type Similarity",
  "admin.ciBuildComparison": "Build Comparison",
  "admin.ciBuildComparisonDesc": "Side-by-side comparison of CI builds between branches",
  "admin.compareBranches": "Compare Branches",
  "admin.branchA": "Branch A",
  "admin.branchB": "Branch B",
  "admin.buildDuration": "Duration",
  "admin.buildSize": "Size",
  "admin.buildStatus": "Status",
  "admin.noBranchBuilds": "No builds found for this branch",
  "admin.durationDiff": "Duration Difference",
  "admin.sizeDiff": "Size Difference",
  "admin.notificationPrefs": "Notification Preferences",
  "admin.notificationPrefsDesc": "Configure which alerts you receive for CI, search quality, and system events",
  "admin.notifCategoryCi": "CI Build Alerts",
  "admin.notifCategorySearch": "Search Quality Alerts",
  "admin.notifCategoryEmbedding": "Embedding Alerts",
  "admin.notifCategorySystem": "System Events",
  "admin.notifChannelInApp": "In-App",
  "admin.notifChannelEmail": "Email",
  "admin.notifEnabled": "Enabled",
  "admin.notifDisabled": "Disabled",
  "admin.notifSaved": "Notification preferences saved",
  "admin.notifSaveError": "Failed to save notification preferences",
  ...
  "search.filterByAuthor": "Filter by author",
  "search.filterByTag": "Filter by tag",
  "search.minVotes": "Min. votes",
  "search.projectScope": "Within project",
  ...
  // Advanced Analytics
  "advancedAnalytics.title": "Advanced Analytics",
  "advancedAnalytics.subtitle": "Vote velocity, momentum, social network, and predictions",
  "advancedAnalytics.backToAdmin": "Admin",
  "advancedAnalytics.velocity": "Vote Velocity",
  "advancedAnalytics.velocityDesc": "Vote accumulation rates and acceleration",
  "advancedAnalytics.momentum": "Momentum Scoring",
  "advancedAnalytics.momentumDesc": "Combined engagement intensity scores",
  "advancedAnalytics.social": "Social Network",
  "advancedAnalytics.socialDesc": "User interaction patterns and influence",
  "advancedAnalytics.predictions": "Success Predictions",
  "advancedAnalytics.predictionsDesc": "Proposal approval likelihood estimates",
  "advancedAnalytics.fastestGrowing": "Fastest Growing",
  "advancedAnalytics.decelerating": "Decelerating",
  "advancedAnalytics.topInfluencers": "Top Influencers",
  "advancedAnalytics.networkDensity": "Network Density",
  "advancedAnalytics.activeUsers": "Active Users",
  "advancedAnalytics.avgConnections": "Avg Connections",
  "advancedAnalytics.topMomentum": "Top Momentum",
  "advancedAnalytics.avgMomentum": "Avg Momentum",
  "advancedAnalytics.topPredictions": "Top Predictions",
  "advancedAnalytics.avgConfidence": "Avg Confidence",
  "advancedAnalytics.rising": "Rising",
  "advancedAnalytics.stable": "Stable",
  "advancedAnalytics.falling": "Falling",
  "advancedAnalytics.likely": "Likely",
  "advancedAnalytics.uncertain": "Uncertain",
  "advancedAnalytics.unlikely": "Unlikely",
  "advancedAnalytics.votesPerDay": "votes/day",
  "advancedAnalytics.acceleration": "acceleration",
  "advancedAnalytics.influence": "Influence",
  "advancedAnalytics.score": "Score",
  "advancedAnalytics.probability": "Probability",
  "advancedAnalytics.confidence": "Confidence",
  "advancedAnalytics.noData": "No data available yet",
  ...
  "workflow.description": "Configure proposal lifecycle workflows per project",
  "workflow.create": "Create Workflow",
  "workflow.creating": "Creating...",
  "workflow.created": "Workflow created",
  "workflow.createFailed": "Failed to create workflow",
  "workflow.delete": "Delete workflow",
  "workflow.deleted": "Workflow deleted",
  "workflow.deleteFailed": "Failed to delete workflow",
  "workflow.none": "No workflows configured",
  "workflow.name": "Workflow Name",
  "workflow.namePlaceholder": "e.g. Standard Approval",
  "workflow.project": "Project",
  "workflow.selectProject": "Select a project...",
  "workflow.stages": "Stages",
  "workflow.addStage": "Add Stage",
  "workflow.stageName": "Stage Name",
  "workflow.stageNamePlaceholder": "e.g. Review",
  "workflow.stageRoles": "Allowed Roles",
  "workflow.removeStage": "Remove stage",
  "workflow.default": "Default",
  "workflow.custom": "Custom",
  "workflow.stageCount": "{count} stages",
  "workflow.assign": "Assign Workflow",
  "workflow.assigned": "Workflow assigned",
  "workflow.assignFailed": "Failed to assign workflow",
  "workflow.status": "Workflow Status",
  "workflow.stage": "Stage",
  "workflow.advance": "Advance",
  "workflow.advancing": "Advancing...",
  "workflow.advanced": "Proposal advanced to {stage}",
  "workflow.advanceFailed": "Failed to advance proposal",
  "workflow.reject": "Reject",
  "workflow.rejecting": "Rejecting...",
  "workflow.rejected": "Proposal rejected",
  "workflow.rejectFailed": "Failed to reject proposal",
  "workflow.completed": "Completed",
  "workflow.active": "Active",
  "workflow.approvalQueue": "Approval Queue",
  "workflow.approvalQueueDesc": "Proposals awaiting your review",
  "workflow.noApprovals": "No proposals awaiting approval",
  "workflow.history": "Approval History",
  "workflow.noHistory": "No approval history",
  "workflow.comment": "Comment (optional)",
  "workflow.commentPlaceholder": "Add a comment...",

  // Permissions
  "permissions.title": "Permissions",
  "permissions.description": "Manage time-based rules, dynamic permissions, and resource ACLs",
  "permissions.testTool": "Test & Simulate",
  "permissions.totalRules": "Total Rules",
  "permissions.activeRules": "Active Rules",
  "permissions.totalAcls": "Resource ACLs",
  "permissions.denyRules": "Deny Rules",
  "permissions.rules": "Permission Rules",
  "permissions.rulesDesc": "Time-based, schedule, deadline, and conditional permission rules",
  "permissions.acls": "Resource ACLs",
  "permissions.aclsDesc": "Per-resource fine-grained access control entries",
  "permissions.createRule": "Create Rule",
  "permissions.createAcl": "Create ACL",
  "permissions.ruleName": "Rule Name",
  "permissions.ruleNamePlaceholder": "e.g. Business hours only editing",
  "permissions.ruleType": "Rule Type",
  "permissions.ruleType_time_expiry": "Time Expiry",
  "permissions.ruleType_schedule": "Schedule",
  "permissions.ruleType_deadline": "Deadline",
  "permissions.ruleType_condition": "Condition",
  "permissions.targetType": "Target Type",
  "permissions.targetType_user": "Specific User",
  "permissions.targetType_role": "Role",
  "permissions.targetType_all": "All Users",
  "permissions.targetUser": "User",
  "permissions.targetRole": "Role",
  "permissions.selectUser": "Select a user...",
  "permissions.selectRole": "Select a role...",
  "permissions.permission": "Permission",
  "permissions.effect": "Effect",
  "permissions.effect_grant": "Grant",
  "permissions.effect_deny": "Deny",
  "permissions.expiresAt": "Expires At",
  "permissions.schedule": "Schedule (JSON)",
  "permissions.condition": "Condition (JSON)",
  ...
  "permissions.noRules": "No permission rules configured",
  "permissions.noAcls": "No resource ACLs configured",
  "permissions.entityType": "Entity Type",
  "permissions.entityId": "Entity ID",
  "permissions.entityIdPlaceholder": "Enter entity UUID",
  "permissions.entityProject": "Project",
  "permissions.entityProposal": "Proposal",
  "permissions.granteeType": "Grantee Type",
  "permissions.granteeUser": "User",
  "permissions.granteeRole": "Role",
  "permissions.granteeId": "Grantee",
  "permissions.reason": "Reason",
  "permissions.reasonPlaceholder": "Reason for this ACL entry",
  "permissions.optional": "optional",
  "permissions.none": "None",
  "permissions.testTitle": "Permission Simulator",
  "permissions.testDesc": "Test permission evaluation for any user, role, and resource combination",
  "permissions.simulateTitle": "Simulate Permission Check",
  "permissions.simulateRole": "Simulate as Role",
  "permissions.runSimulation": "Run Simulation",
  "permissions.allowed": "Allowed",
  "permissions.denied": "Denied",
  "permissions.finalVerdict": "Final Verdict",
  "permissions.ruleId": "Rule ID",
  "permissions.staticRbac": "Static RBAC Result",
  "permissions.matchingRules": "Matching Rules",
  ...
  "collaboration.reviewing": "reviewing",
  "collaboration.typing": "typing",
  "collaboration.idle": "idle",
  ...
  "perfDashboard.title": "Performance Dashboard",
  "perfDashboard.subtitle": "Unified performance metrics, cache stats, and alerting",
  "perfDashboard.avgResponse": "Avg Response",
  "perfDashboard.cacheHitRate": "Cache Hit Rate",
  "perfDashboard.memoryUsage": "Memory Usage",
  "perfDashboard.activeAlerts": "Active Alerts",
  "perfDashboard.dbPool": "Database Pool",
  "perfDashboard.maxConn": "Max Connections",
  "perfDashboard.activeConn": "Active",
  "perfDashboard.idleConn": "Idle",
  "perfDashboard.peakActive": "Peak Active",
  "perfDashboard.totalAcquired": "Total Acquired",
  "perfDashboard.stmtsCached": "Stmt Cache",
  "perfDashboard.cacheDetails": "Cache Details",
  "perfDashboard.memEntries": "Memory Entries",
  "perfDashboard.redisEnabled": "Redis Enabled",
  "perfDashboard.redisHits": "Redis Hits",
  "perfDashboard.trackedTags": "Tracked Tags",
  "perfDashboard.taggedKeys": "Tagged Keys",
  ...
  "integrations.loadFailed": "Failed to load integrations data",
  "integrations.platformTitle": "Platform Integrations",
  "integrations.namePlaceholder": "Integration name",
  "integrations.webhookUrlPlaceholder": "https://hooks.slack.com/services/...",
  "integrations.addIntegration": "Add Integration",
  "integrations.noIntegrations": "No platform integrations configured",
  "integrations.created": "Integration created",
  "integrations.createFailed": "Failed to create integration",
  "integrations.deleted": "Integration deleted",
  "integrations.deleteFailed": "Failed to delete integration",
  "integrations.updateFailed": "Failed to update integration",
  "integrations.test": "Test integration",
  "integrations.testSuccess": "Test message sent successfully",
  "integrations.testFailed": "Test message failed",
  "integrations.deliveriesTotal": "Total Deliveries",
  "integrations.deliveriesSuccess": "Successful",
  "integrations.deliveriesFailed": "Failed",
  "integrations.activeKeys": "Active API Keys",
  "integrations.apiKeysTitle": "API Keys",
  "integrations.keyNamePlaceholder": "Key name (e.g., CI/CD Pipeline)",
  "integrations.createKey": "Create Key",
  "integrations.keyCreated": "API key created",
  "integrations.keyCreateFailed": "Failed to create API key",
  "integrations.keyRevealMessage": "Save this key — it will not be shown again:",
  "integrations.dismissKey": "Dismiss",
  "integrations.noKeys": "No API keys created",
  "integrations.requests": "requests",
  "integrations.perHour": "hr",
