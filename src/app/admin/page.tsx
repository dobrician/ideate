...
import { Users, FolderOpen, Lightbulb, ThumbsUp, ShieldX, BarChart3, Gauge, Activity, TrendingUp, GitBranch, Shield, Search, Zap, Brain } from "lucide-react";
    ...
    <div className="mx-auto max-w-6xl py-4 sm:py-8">
      <div className="mb-5 flex items-center justify-between sm:mb-8">
        ...
        <div className="flex gap-2">
          ...
          <Button variant="outline" asChild>
            <Link href="/analytics"><TrendingUp className="mr-1.5 h-4 w-4" />{t("advancedAnalytics.title")}</Link>
          </Button>
          <Button variant="outline" asChild>
            <Link href="/admin/workflows"><GitBranch className="mr-1.5 h-4 w-4" />{t("workflow.title")}</Link>
          </Button>
          <Button variant="outline" asChild>
            <Link href="/admin/permissions"><Shield className="mr-1.5 h-4 w-4" />{t("permissions.title")}</Link>
          </Button>
          <Button variant="outline" asChild>
          ...
          <Button variant="outline" asChild>
            <Link href="/admin/embeddings"><Brain className="mr-1.5 h-4 w-4" />{t("admin.embeddings")}</Link>
          </Button>
          <Button variant="outline" asChild>
