...
- [ ] **Goal 1: Fix broken `proposal-list.dom.test.tsx` bar chart assertions** — test expected old 50%-scaled widths but component uses full percentage (60/40/67/33/100); align test with actual rendering (Testing)
