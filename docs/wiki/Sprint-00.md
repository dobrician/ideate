...
- [ ] **Goal 1: Fix PWA banner mobile overlap** — Move the PWA install banner from `fixed top-16` to bottom position on mobile to prevent content overlap. Desktop already uses `sm:bottom-4`.
