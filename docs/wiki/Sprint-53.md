...
- [ ] **Goal 2: Conflict Detection Engine** — `src/lib/ai/conflicts.ts` to detect contradictory proposals using semantic analysis. Conflict warnings in UI with explanations. Periodic conflict detection via job queue.
